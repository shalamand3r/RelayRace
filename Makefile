...
after-stage::
	...
	if [ -x tools/macprep/relayrace-ct-bypass-mac ]; then tools/macprep/relayrace-ct-bypass-mac -i $(THEOS_STAGING_DIR)/Library/MobileSubstrate/DynamicLibraries/RelayRace.dylib -r; fi
